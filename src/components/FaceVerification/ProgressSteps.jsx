...
const ProgressSteps = ({ step, faceImage, docImage, result }) => {
  const steps = [
    {
      title: "Face Capture",
      description: "Capture your face using the webcam",
      status:
        step === "face"
          ? "in-progress"
          : faceImage
    ...
    },
    {
      ...
      description: "Capture your Aadhar/PAN card",
      status:
        step === "document"
          ? "in-progress"
          : docImage
    ...
    {
      title: "Face Matching",
      description: "Verify face match with document",
      status:
        step === "result" ? "in-progress" : result ? "completed" : "pending",
    },
  ];
